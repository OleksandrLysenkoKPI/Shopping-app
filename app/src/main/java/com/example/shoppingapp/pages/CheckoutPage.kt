...
fun CheckoutPage(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        CheckoutItemsRow(title = "Subtotal", value = "%.2f".format(subTotal.value))
        Spacer(modifier = Modifier.height(16.dp))
        CheckoutItemsRow(title = "Discount (-)", value = "%.2f".format(discount.value))
        Spacer(modifier = Modifier.height(16.dp))
        CheckoutItemsRow(title = "Tax (+)", value = "%.2f".format(tax.value))
        Spacer(modifier = Modifier.height(16.dp))
        HorizontalDivider()
        Spacer(modifier = Modifier.height(16.dp))
        Text(
...
@Composable
fun CheckoutItemsRow(title: String, value: String) {
    Row(
        modifier = Modifier.fillMaxWidth(),
